...
const EMAILJS_CONFIG = {
  SERVICE_ID: 'service_22vkh3y',
  TEMPLATE_ID: 'template_n8ijoze',
  PUBLIC_KEY: 'U9agF7j2ortgE3nfW'
};
...
const Contact = () => {
  ...
  const handleCVDownload = () => {
    const cvUrl = '/CV_Bacem_Ben Akkari.pdf';
  ...
  const handleEmailJSSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Initialize EmailJS (if not already done globally)
      ...
      setStatusMessage('Erreur lors de l\'envoi. Veuillez réessayer ou me contacter directement.');
    }
  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/bacembenakkari",
      color: "gray"
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      username: "@bacembenakkari",
      url: "https://linkedin.com/in/bacembenakkari",
      color: "blue"
    }
  ];
